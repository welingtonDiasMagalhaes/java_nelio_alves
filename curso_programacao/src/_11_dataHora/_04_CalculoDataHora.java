...
public class _04_CalculoDataHora {
	public static void main(String[] args) {
		...
		Duration t1 = Duration.between(pastWeekDate.atStartOfDay(), d04.atStartOfDay()); //localDate
		Duration t2 = Duration.between(pastWeekLocalDate, d05); //localDateTime
		Duration t3 = Duration.between(pastWeekInstant, d06); //instant
		Duration t4 = Duration.between(d06, pastWeekInstant); //instant
